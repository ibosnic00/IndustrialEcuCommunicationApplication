...
namespace j1939.Test.Unit
{
    public class HelpersTests
    {
        ...
        {
            string candumpString = "can0  RX - -  0000CF00   [8]  01 55 02 88 12 AA 0A EE";
        ...
        {
            string candumpString = "can1  RX - -  7DF   [8]  02 01 0C 00 00 00 00 00";
        ...
        {
            string candumpString = "can0 RX - -  2 [4] 11 22 33 44";
        ...
        [Test]
        public void CandumpStringToCanMessage_TxMessage_NullReturn()
        {
            string candumpString = "can0 TX - -  2 [4] 11 22 33 44";
            var result = Helpers.CandumpStringToCanMessage(candumpString);
        ...
        [Test]
        public void CandumpStringToCanMessage_InvalidChannel_NullReturn()
        {
            string candumpString = "vcan TX - -  2 [4] 11 22 33 44";
            var receivedCanMessage = Helpers.CandumpStringToCanMessage(candumpString);

            Assert.AreEqual(null, receivedCanMessage);
        }

        [Test]
        public void CandumpStringToCanMessage_DataLen4ButDataIs8_Parsed4Bytes()
        {
            string candumpString = "can2 RX - -  2 [4] 11 22 33 44 55 66 77 88";
            var expectedData = new byte[] { 0x11, 0x22, 0x33, 0x44 };
            var result = Helpers.CandumpStringToCanMessage(candumpString);
        ...
        {
            string candumpString = "can2 RX - -  002 [1] 11 22 33 44 55 66 77 88";
            string candumpString2 = "can2 RX - -  002 [1] 11";
